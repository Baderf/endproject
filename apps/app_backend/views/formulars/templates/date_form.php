<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 user_input_field input_field date_input" data-table-id="<?php echo $data['user_form_' . $id]['id']; ?>" data-type="<?php echo $data['user_form_' . $id]['type']; ?>" data-table-input-id="<?php echo $data['user_form_' . $id]['id']; ?>" data-table-type="date">
    ...
    <dd>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                <div class="form-group has-feedback has-feedback-left default_value">
                    ...
                    <input class="form-control datepicker_userspec" name="formtitle" type="text" placeholder="Your formular title..." value="<?php if(!empty($data['user_form_' . $id]['default_value'])){echo $data['user_form_' . $id]['default_value']; }; ?>">
                    <i class="glyphicon glyphicon-plus form-control-feedback"></i>
                </div>
            </div>
        </div>
        ...
        <div class="hidden_fields">
            ...
            <input type="hidden" class="hidden_user_field_type_<?php echo $data['user_form_' . $id]['id']; ?>" name="user_field_type_<?php echo $data['user_form_' . $id]['id']; ?>" value="date">
