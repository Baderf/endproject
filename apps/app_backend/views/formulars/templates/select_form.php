<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 user_input_field user_input_select select_field_area select_field_area_<?php echo $data['user_form_' . $id][0]['id']; ?>" data-type="select" data-table-type="select" data-table-input-id="<?php echo $data['user_form_' . $id][0]['id']; ?>" data-user-field-id="<?php echo $data['user_form_' . $id][0]['id']; ?>">
    ...
    <dd>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div class="form-group form_build_selection" >
                <label class="control-label" for="selection_user" id="field_title_<?php echo $data['user_form_' . $id][0]['title']; ?>">Defaultvalue:</label>
                <select class="form-control selection_user" name="form_selection_<?php echo $data['user_form_' . $id][0]['id']; ?>" >

                    <?php

                    // FOREACH DATA VALUES "," $data['user_form_' . $id][0]['id'];
                    $values = explode("::", $data['user_form_' . $id][0]['data_values']);

                    foreach ($values as $key){
                        $key = str_replace(":", "", $key);
                        if($key === $data['user_form_' . $id][0]['default_value']){
            ...
            <div class="hidden_fields">
                ...
                <input type="hidden" class="hidden_user_field_type_<?php echo $data['user_form_' . $id][0]['id']; ?>" name="user_field_type_<?php echo $data['user_form_' . $id][0]['id']; ?>" value="select">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
            ...
            <a href="#" class="btn btn-sm btn-success btn-selection-field-adder" data-table-id="<?php echo $data['user_form_' . $id][0]['id']; ?>"> add
            </a>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 selection_table">
            <p>Your possible Selections:</p>
            <table class="table table-striped form_field_options" data-table-id="<?php echo $data['user_form_' . $id][0]['id']; ?>">
                <thead>
                <tr>
                    <td>Name</td>
                    <td>Edit</td>
                ...
                <tbody class="tbody_id_<?php echo $data['user_form_' . $id][0]['id']; ?>" data-table-id="<?php echo $data['user_form_' . $id][0]['id']; ?>">
                <?php
                ...
                foreach ($values as $key){
                    ...
                    <tr data-table-id="<?php echo $data['user_form_' . $id][0]['id']; ?>" class="is_selection" data-table-type="selection">
                        <td>
