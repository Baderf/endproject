    ...
    <div>
        <div class="col-lg-12 col-md-12 col-sm-12 create_event my_container clearfix">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 date_area">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  spec_event date_area_from">
                    <h4>from:</h4>
                    <p class="year">2016</p>
                    <p class="day">Thu,</p>
                    <p class="monthandday">Apr 13 (04 p.m.)</p>
                    <span class="hover_date_area">Click to select</span>
                </div>
                ...
                <div style="overflow:hidden;">
                    ...
                    <script type="text/javascript">
                        ...
                        $(function () {
                            ...
                            $('#datetimepicker_from').datetimepicker();
                            $('#datetimepicker_from').on("changeDate", function() {
                                $('#date_from').val(
                                    $('#datetimepicker_from').datetimepicker('getFormattedDate')
                                );
                            });
                        ...
                        $(function () {
                            ...
                            $('#datetimepicker_to').datetimepicker();
                            $('#datetimepicker_to').on("changeDate", function() {
                                $('#date_to').val(
                                    $('#datetimepicker_to').datetimepicker('getFormattedDate')
                                );
                            });
