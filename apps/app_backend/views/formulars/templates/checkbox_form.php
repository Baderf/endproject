<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 user_input_field user_input_checkbox select_field_area select_field_area_<?php echo $data['user_form_' . $id]['id']; ?>" data-type="checkbox" data-table-type="checkbox" data-table-input-id="<?php echo $data['user_form_' . $id]['id']; ?>" data-user-field-id="<?php echo $data['user_form_' . $id]['id']; ?>">
    ...
    <dd>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            ...
            <div class="hidden_fields">
                ...
                <input type="hidden" class="hidden_user_field_type_<?php echo $data['user_form_' . $id]['id']; ?>" name="user_field_type_<?php echo $data['user_form_' . $id]['id']; ?>" value="checkbox">
