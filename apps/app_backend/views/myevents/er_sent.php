<div class="wrapper clearfix">
    ...
    <div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 create_event my_container clearfix">
                ...
                <hr>
                <div class="hidden_message alert alert-warning info_shown">
                    <strong>Warning!</strong> There happened some problems sending the mail to some user!
                </div>

                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <p>The mail was sent succesful but some user didn't get the mail:</p>

                    <hr>

                    <h4>User which didn't get the mail:</h4>
                    <?php
                        var_dump($data['sending_errors']);
                    ?>
                </div>
