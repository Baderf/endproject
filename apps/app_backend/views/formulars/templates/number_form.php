<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 user_input_field input_field number_field" data-table-id="<?php echo $data['user_form_' . $id][0]['id']; ?>" data-table-input-id="<?php echo $data['user_form_' . $id][0]['id']; ?>" data-table-type="number">
    ...
    <dd>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 min_max">
            ...
            <?php
                if(isset($data['user_form_' . $id][0]['data_values'])){
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                <div class="form-group has-feedback has-feedback-left">
                    ...
                    <input class="form-control input_field_placeholder min_value_field" name="formtitle" type="number" placeholder="min-value" value="<?php if(!empty($values[0])){echo $values[0];}?>">
                    <i class="glyphicon glyphicon-plus form-control-feedback"></i>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
        ...
        <div class="hidden_fields">
            ...
            <input type="hidden" class="hidden_user_field_type_<?php echo $data['user_form_' . $id][0]['id']; ?>" name="user_field_type_<?php echo $data['user_form_' . $id][0]['id']; ?>" value="number">
