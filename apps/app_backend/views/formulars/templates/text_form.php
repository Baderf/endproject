<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 user_input_field input_field text_input" data-table-id="<?php echo $data['user_form_' . $id][0]['id']; ?>" data-table-input-field="<?php echo $data['user_form_' . $id][0]['id']; ?>" data-table-input-id="<?php echo $data['user_form_' . $id][0]['id']; ?>" data-table-type="text">
    ...
    <dd>
        ...
        <div class="hidden_fields">
            ...
            <input type="hidden" class="hidden_user_field_type_<?php echo $data['user_form_' . $id][0]['id']; ?>" name="user_field_type_<?php echo $data['user_form_' . $id][0]['id']; ?>" value="text">
